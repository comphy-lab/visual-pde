...
presets["RockPaperScissorsLizardSpock"] = {
  ...
  diffusionStr_5_5: "D",
  dt: 0.005,
  expressions: "rho = u+v+w+p+q;",
  initCond_1: "(1/(5+2*sigma))*(1+0.1*RANDN)",
  initCond_2: "1/(5+2*sigma)",
  initCond_3: "1/(5+2*sigma)",
  initCond_4: "1/(5+2*sigma)",
  initCond_5: "1/(5+2*sigma)",
  kineticParams: "D = 1;sigma = 3.2;zeta = 0.8;",
  numSpecies: "5",
  parent: "cyclicCompetitionWave",
  preset: "RockPaperScissorsLizardSpock",
  reactionStr_1: "u*(1-rho-(sigma+zeta)*(v+p)+zeta*(w+q))",
  reactionStr_2: "v*(1-rho-(sigma+zeta)*(w+q)+zeta*(p+u))",
  reactionStr_3: "w*(1-rho-(sigma+zeta)*(p+u)+zeta*(q+v))",
  reactionStr_4: "p*(1-rho-(sigma+zeta)*(q+v)+zeta*(u+w))",
  reactionStr_5: "q*(1-rho-(sigma+zeta)*(u+w)+zeta*(v+p))",
  speciesNames: "u v w p q",
  timescales: true,
  simTitle: "Rock Paper Scissors Lizard Spock",
  views: [
    {
      colourbar: true,
      whatToPlot: "u",
...
presets["KymographLinearGrowth"] = {
  ...
  diffusionStr_2_2: "0",
  diffusionStr_3_3: "0",
  domainIndicatorFun: "abs(x) < (L_0+(t/T)*(L_x-L_0))/2",
  domainScale: "1000",
  domainViaIndicatorFun: true,
  dt: 0.05,
  ...
  kineticParams:
    "a = 0.05 in [0, 0.1];b = 0.06 in [0.04, 0.1];T = 5000;L_0 = 200;r = 0.001;",
  minX: "-L_x/2",
  numSpecies: 3,
  numTimestepsPerFrame: 200,
  ...
  views: [
    ...
    },
    {
      ...
      overlayEpsilon: 0.01,
      overlayExpr:
        "ind(y-t*L_y/T<dy)*ind(abs(x) < L_0+((y-L_0*dy)/(2*L_y))*(L_x-L_0))",
      plotType: "plane",
      whatToPlot: "m",
      name: "Kymograph",
    },
...
presets["KymographExponentialGrowth"] = {
  ...
  diffusionStr_2_2: "0",
  diffusionStr_3_3: "0",
  domainIndicatorFun: "abs(x) < L_0*L_x*exp(r*(t))/2",
  domainScale: "1000",
  domainViaIndicatorFun: true,
  dt: 0.02,
  ...
  kineticParams:
    "a = 0.05 in [0, 0.1];b = 0.06 in [0.04, 0.1];T = 2000;L_0 = 0.1;r = 0.0012000 in [0.0012, 0.01];",
  minX: "-L_x/2",
  numSpecies: 3,
  ...
  views: [
    ...
    },
    {
      ...
      overlayEpsilon: 0.01,
      overlayExpr:
        "ind(y-t*L_y/T<dy)*ind(abs(x) < (L_0*L_x*exp(r*T*(y/(L_y)))/2))",
      plotType: "plane",
      whatToPlot: "m",
      name: "Kymograph",
    },
  ...
  whatToDraw: "u",
  simTitle: "Gray–Scott on an exponentially growing domain",
};
...
presets["CahnHilliard"] = {
  crossDiffusion: true,
  diffusionStr_1_1: "r*(3*u^2-1)",
  diffusionStr_1_2: "-epsilon",
  diffusionStr_2_1: "1",
  diffusionStr_2_2: "0",
  diffusionStr_3_3: "0",
  dt: 0.001,
  initCond_1: "tanh(30*(RAND-0.5))",
  kineticParams: "r = 0.250 in [0, 0.1, 5];epsilon = 0.8 in [0.2, 0.01, 0.8];",
  minColourValue: "-1",
  numAlgebraicSpecies: 1,
  preset: "CahnHilliard",
  probeFun: "u",
...
presets["SchnakenbergGrowingDisk"] = {
  ...
  brushRadius: "10",
  brushValue: "2",
  domainIndicatorFun: "(L/L_0+r*t)^2 - ((x-L_x/2)^2 + (y-L_y/2)^2)",
  domainScale: "400",
  domainViaIndicatorFun: true,
  dt: 0.001,
